...
<!--         <ul class="navbar-nav px-3">
            <li class="nav-item dropdown"> -->
                <a id="navbarDropdown" class="nav-link dropdown-toggle login-user" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-info sidebar collapse" min-height>
      <div class="sidebar-sticky pt-3">
        ...
        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 save-report">
